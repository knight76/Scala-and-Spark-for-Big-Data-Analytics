...
object UsingImplicitConversion {
  def main(args: Array[String]): Unit = {
    ...
    println(x) // "4.0 + 3.0i"을 출력한다
    println(x plus y) // "12.0 + -4.0i"을 출력한다
    println(x minus y) // "-4.0 + 10.0i"을 출력한다
    println(obj.unary) // "7.810249675906654"을 출력한다

    val z = 4 plus y
    println(z) // "12.0 + -7.0i"을 출력한다
    val p = (1.0, 1.0) plus z
    println(p) // "13.0 + -6.0i"을 출력한다
  }
}